...
public class PmsProduct implements Serializable {
    ...
    public Long getLebelGroupId() {
        return lebelGroupId;
    }

    public void setLebelGroupId(Long lebelGroupId) {
        this.lebelGroupId = lebelGroupId;
    }
    ...
    public String toString() {
        ...
        sb.append(", lebelGroupId=").append(lebelGroupId);
