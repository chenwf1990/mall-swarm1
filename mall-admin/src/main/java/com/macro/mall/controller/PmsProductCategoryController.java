...
public class PmsProductCategoryController {
    ...
    @ApiOperation("查询添加商品最近历史使用数据")
    @RequestMapping(value = "/listCategoryHistory", method = RequestMethod.GET)
    @ResponseBody
    public CommonResult getListHistory(@RequestParam(value = "userId", defaultValue = "5") Long userId) {
        List<CategoryHistoryVo> history = productCategoryService.getListHistory(userId);
