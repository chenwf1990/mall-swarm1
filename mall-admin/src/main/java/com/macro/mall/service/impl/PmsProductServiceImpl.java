...
public class PmsProductServiceImpl implements PmsProductService {
    ...
    public int create(PmsProductParam productParam) {
        ...
        pmsProductCategoryHistoryMapper.insertSelective(history);
        count = 1;
        return count;
    }
    ...
    public List<PmsProduct> list(PmsProductQueryParam productQueryParam, Integer pageSize, Integer pageNum) {
        ...
        if (productQueryParam.getProductCategoryIdI() != null) {
            criteria.andProductCategoryIdIEqualTo(productQueryParam.getProductCategoryIdI());
        }
        if (productQueryParam.getProductCategoryIdIii() != null) {
            criteria.andProductCategoryIdIiiEqualTo(productQueryParam.getProductCategoryIdIii());
        }
