...
public class PmsProductParam extends PmsProduct {
    ...
    @ApiModelProperty("商品推荐和商品的关系")
    private List<PmsProductRecommend> pmsProductRecommendList;
    ...
    public List<PmsProductRecommend> getPmsProductRecommendList() {
        return pmsProductRecommendList;
    }

    public void setPmsProductRecommendList(List<PmsProductRecommend> pmsProductRecommendList) {
        this.pmsProductRecommendList = pmsProductRecommendList;
    }
}
